...
class TestUrls(SimpleTestCase):
    ...
    def url_is_resolved(self):
        ...
        self.assertEquals(resolve(url).func, views.viewDays)
        url = reverse('configuracao:editarDia')
        self.assertEquals(resolve(url).func, views.newDay)
        url = reverse('configuracao:novoDia', kwargs={'id':1})
        self.assertEquals(resolve(url).func, views.newDay)
        ...
        self.assertEquals(resolve(url).func, views.viewMenus)
        ...
        self.assertEquals(resolve(url).func, views.verTransportes)
        ...
        self.assertEquals(resolve(url).func, views.verUOs)
        ...
        self.assertEquals(resolve(url).func, views.verTemas)
        ...
        self.assertEquals(resolve(url).func, views.verDepartamentos)
        ...
        self.assertEquals(resolve(url).func, views.verCursos)
