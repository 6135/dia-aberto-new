...
class EnviarMensagemAdmiGrupo(StaticLiveServerTestCase):
    ...
    def test_receber_mensagem(self):
        ...
        self.driver.find_element(By.LINK_TEXT, "Ver todas as mensagens").click()
        self.driver.find_element(By.CSS_SELECTOR, "#inbox-messages .card-content").click()
        assert self.driver.find_element(By.CSS_SELECTOR, ".card-content > strong").text == "Não existem mensagens"
