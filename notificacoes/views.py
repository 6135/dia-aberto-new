...
def enviar_notificacao_automatica(request, sigla, id):
    ...
    if sigla == "cancelarTarefa":
        ...
        notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                    target=None, level="error", description=titulo, public=False, timestamp=timezone.now(), tarefa_id=id)
    # Enviar notificacao ao enviar confirmação do cancelamento da tarefa - coordenador
        ...
        notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                    target=None, level="sucess", description=titulo, public=False, timestamp=timezone.now(), tarefa_id=id)
    ...
    # Enviar notificação atividade confirmada - professor universitario
        ...
        notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                    target=None, level="sucess", description=titulo, public=False, timestamp=timezone.now(), atividade_id=id)
    ...
    # Enviar notificação tarefa alterada - colaborador
        ...
        if tarefa.estado != "naoAtribuida":
            ...
            user_recipient = Utilizador.objects.get(id=tarefa.colab.id)
            notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                        target=None, level="warning", description=titulo, public=False, timestamp=timezone.now(), tarefa_id=id)
    # Enviar notificação atividade apagada - coordenador
        ...
        notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                    target=None, level="error", description=titulo, public=False, timestamp=timezone.now(),atividade_id=id)
    # Enviar notificação atividade alterada - coordenador
        ...
        user_recipient = Utilizador.objects.get(id=atividade.coordenadorutilizadorid.id)
        notify.send(sender=user_sender, recipient=user_recipient, verb=descricao, action_object=None,
                    target=None, level="warning", description=titulo, public=False, timestamp=timezone.now(),atividade_id=id)
    ...
    #     notify.send(sender=user, recipient=user, verb="oi", action_object=None, target=None, level="info",
