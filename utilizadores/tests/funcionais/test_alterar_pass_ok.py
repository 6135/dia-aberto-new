...
class AlterarPassTestOk(StaticLiveServerTestCase):
    ...
    def test_alterarPass(self):
        ...
        self.driver.find_element(By.CSS_SELECTOR, ".dropdown-item:nth-child(2) > strong").click()
        ...
        self.driver.find_element(By.ID, "id_new_password1").send_keys("andre1234567")
        self.driver.find_element(By.ID, "id_new_password2").click()
        self.driver.find_element(By.ID, "id_new_password2").send_keys("andre1234567")
        self.driver.find_element(By.ID, "id_new_password2").send_keys(Keys.ENTER)
        assert self.driver.find_element(By.CSS_SELECTOR, ".message-body strong").text == "Senha alterada com sucesso!"    